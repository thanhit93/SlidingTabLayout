...
public class SlidingDrawableTabLayout extends HorizontalScrollView {
    ...
    private static final int DEFAULT_HEIGHT = 40; // dps
    private static final int TAB_MIN_WIDTH_MARGIN = 45; //dps
    ...
    private void updateTabViewLayoutParams(LinearLayout.LayoutParams lp) {
        if (mMode == MODE_FIXED && mTabGravity == GRAVITY_FILL) {
            lp.width = 0;
            lp.weight = mTabStrip.getChildCount() == 1 ? 1.2f : 1; // đang thêm view thư 3
        } else {
    ...
    private void updateTabViews(final boolean requestLayout) {
        for (int i = 0; i < mTabStrip.getChildCount(); i++) {
            ...
            if (mTabStrip.getChildCount() > 1 && mMode == MODE_FIXED && mTabGravity == GRAVITY_FILL) {
                lp.width = 0;
                lp.weight = i == 1 ? 1.2f : 1;
            } else {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        SlidingTabStrip(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            a = context.obtainStyledAttributes(attrs, R.styleable.SlidingDrawableTabLayout,
                    defStyleAttr, -1);
            mSlidingDrawable = a.getDrawable(R.styleable.SlidingDrawableTabLayout_slidingBackground1);
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            if (position == 0) {
                ...
                mSlidingDrawable = a.getDrawable(R.styleable.SlidingDrawableTabLayout_slidingBackground2);
            } else {
                mSlidingDrawable = a.getDrawable(R.styleable.SlidingDrawableTabLayout_slidingBackground3);
            }
...
//            }
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (position == i) {
                    ...
                    mAnimationSet.playTogether(scaleX, scaleY);
                    mAnimationSet.setDuration(500);
                    mAnimationSet.start();
                    if (view instanceof TabView) {
                        TabView tabView = (TabView) view;
                        tabView.mTextView.setTextColor(i == 2 ? getResources().getColor(android.R.color.black) :
                    ...
                    if (view.getScaleX() != 1) {
                        ObjectAnimator scaleX = ObjectAnimator.ofFloat(view, View.SCALE_X, 1.1f, 1f);
                        ObjectAnimator scaleY = ObjectAnimator.ofFloat(view, View.SCALE_Y, 1.1f, 1f);
                        final AnimatorSet mAnimationSet = new AnimatorSet();
                        mAnimationSet.playTogether(scaleX, scaleY);
                        mAnimationSet.setDuration(500);
                        mAnimationSet.start();
                    ...
                    if (view instanceof TabView) {
                        TabView tabView = (TabView) view;
                        tabView.mTextView.setTextColor(getResources().getColor(android.R.color.white));
                    }
                }
            }
            ...
            if (tabLayout != null) {
               ...
               /* final boolean updateIndicator = !(mScrollState == SCROLL_STATE_SETTLING
                ...
                if (isUpdate) {
                    ...
                    tabLayout.setScrollPosition(position, positionOffset, updateText, false);
                }
